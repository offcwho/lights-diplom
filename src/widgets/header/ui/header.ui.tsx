...
export const HeaderUi = () => {
    ...
    return (
        <header className="max-w-7xl w-full mx-auto px-6 py-6 flex items-center justify-between border-b border-black/5 sticky top-0 z-9999 rounded-b-4xl" id="header" style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)' }}>
            <Link
                href={'/'}
