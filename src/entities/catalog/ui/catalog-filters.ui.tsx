...
export const CatalogFiltersUi = ({ className, style, onClose }: { className?: string; style?: React.CSSProperties; onClose?: () => void; }) => {
    ...
    return (
        <PageStagger
            className={`${className}  backdrop-blur-xl bg-white/30 p-6 rounded-3xl border border-black/5 sticky top-6 space-y-8 shadow-[0_8px_30px_rgba(0,0,0,0.02)] overflow-hidden`}
            style={style}    
        >
            <PageItem>
